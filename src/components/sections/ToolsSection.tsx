      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {tools.map((tool) => {
          ...
          return (
            ...
            >
              <div className="w-16 h-16 rounded-[16px] bg-white flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-105 transition-transform duration-300">
